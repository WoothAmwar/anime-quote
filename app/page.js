 ...
 */
function get_random_anime_quote() {
...
function get_random_office_quote() {
...
export default function Home() {
  ...
  const header_quote = () => {
    if (modeIndex == 0) {  // anime
      return "In What Anime Did a Character Say This Quote?"
    }
    else if (modeIndex == 1) { // office
      return "What Character in the show 'The Office' Said This Quote?"
    }
  }
  ...
  return (
    <div className="grid justify-center gap-y-6 py-4">
      ...
      <div className="grid grid-rows-2 grid-flow-col justify-center text-2xl">
        <div>Overall High Score: {highScore}</div>
